...
public class TwoBallRockWallMode extends AutoModeBase {
    ...
    public double mDistanceToDrive = 140;
    ...
    protected void routine() throws AutoModeEndedException {
        ...
        first_path.add(new Path.Waypoint(new Translation2d(0, 0), 48.0));
        first_path.add(new Path.Waypoint(new Translation2d(DISTANCE_TO_DROP_ARM, 0), 36.0, "DropArm"));
        first_path.add(new Path.Waypoint(new Translation2d(mDistanceToDrive, 0), 48.0));

        List<Path.Waypoint> return_path = new ArrayList<>();
        return_path.add(new Path.Waypoint(new Translation2d(mDistanceToDrive, 0), 48.0));
        return_path.add(new Path.Waypoint(new Translation2d(6, 0), 15.0, "WatchLine"));
        return_path.add(new Path.Waypoint(new Translation2d(-18, 0), 15.0));
        ...
        second_shot_path.add(new Path.Waypoint(new Translation2d(lineRobotPose.getTranslation().getX(), mCreepDistance), 80.0));
        second_shot_path.add(new Path.Waypoint(new Translation2d(lineRobotPose.getTranslation().getX() + mDistanceToDrive, 0), 80.0));
