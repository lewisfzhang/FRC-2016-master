...
/**
 * A basic framework for the control board
 * Like the drive code, one instance of the ControlBoard object is created
 * upon startup, then other methods request the ControlBoard instance.
 */
