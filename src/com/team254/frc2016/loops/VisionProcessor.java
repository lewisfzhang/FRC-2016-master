...
/**
 * This function adds vision updates (from the Nexus smartphone) to a
 * list in RobotState. This helps keep track of goals detected by the vision system.
 * The code to determine the best goal to shoot at and prune old Goal tracks
 * is in GoalTracker.java
 * 
