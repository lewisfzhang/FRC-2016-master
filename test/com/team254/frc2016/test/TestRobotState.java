...
public class TestRobotState {
    ...
    public void smokeTest() {
        ...
        // Check the latest state.
        assertEquals(next_time, rs.getLatestOdometricToVehicle().getKey().value.doubleValue(), kTestEpsilon);
        ...
        assertEquals(next_time, rs.getLatestTurretRotation().getKey().value.doubleValue(), kTestEpsilon);
        ...
        // Test interpolation
        double interp_time = next_time - 5000000;
    ...
    public void simulatedTest() {
        ...
        for (int i = 1; i <= 360; ++i) {
            double timestamp = start_time + i * kTimestep;
